...
export default function RecentArchivePosts() {
  ...
  return (
    <section className="mb-12">
      ...
      <div className="space-y-4">
        {posts.map((post) => (
          <Link 
            ...
            className="group"
          >
            <BrutalistBlock className="p-4 hover:shadow-brutalist-lg transition-all flex gap-4 items-start">
              {/* Icon */}
              ...
              <div className="flex-grow min-w-0">
                ...
                {/* Title */}
                <h3 className="font-bold uppercase mb-1 group-hover:text-accent transition-colors truncate">
                  {post.title}
                </h3>
      ...
      {posts.length === 0 && (
        <BrutalistBlock className="p-8 text-center">
