...
import type { SurvivalIndex } from "@/lib/weatherTypes";
          ...
          <div className="flex items-center gap-4">
            <div className="flex-grow h-8 bg-background-secondary border-2 border-border-primary overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span className="text-[8px] font-bold font-mono text-white mix-blend-difference uppercase tracking-[0.3em]">Operational Status</span>
              </div>
            </div>
